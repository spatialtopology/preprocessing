...
# Code: generated by Zizhuang Miao
# Modified by Heejung Jung 
# [ ] situation 
# [ ] stim_file remove the trajectory feelings
import os, re, glob
import pandas as pd
import numpy as np
import traceback
...
def narrative_format2bids(sub, ses, run, taskname, beh_inputdir, bids_dir):
    ...
    # for t in range(trial_num):    # each trial
        ...
        #source_beh['situation'] = sousituation
    ...
    for t in range(trial_num):    # each trial
        ...
        # Event 2. feeling rating __________________________________
