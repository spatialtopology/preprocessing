...
error_log="errorlog_BOLD_DUP_TRMISMATCH.txt"
...
dup_files=(
    "./sub-0034/ses-04/func/sub-0034_ses-04_task-fractional_acq-mb8_run-01_bold__dup-01.json"
    "./sub-0038/ses-03/func/sub-0038_ses-03_task-shortvideo_acq-mb8_run-01_bold__dup-01.json"
    "./sub-0075/ses-03/func/sub-0075_ses-03_task-shortvideo_acq-mb8_run-01_bold__dup-01.json"
)
...
for DUPJSON in "${dup_files[@]}"; do
    ...
    for key in "${!myArray[@]}"; do
        if [[ "$filename" == *"$key"* ]]; then
            ...
            #         "$DUPJSON_TR" -eq "$EXPECTED_TR" && \
            #         "$DUPJSON_SEC" -lt "$BOLDJSON_SEC" ]]; then
