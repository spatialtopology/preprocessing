...
__author__ = "Heejung Jung, Owen Collins, Michael Sun"
...
# extract dvars and fd info from fmriprep_confounds_timeseries
# calculate mean and append it with BIDS data
flist = sorted(glob.glob(join(fmriprep_dir, sub, '*', 'func', f'{sub}_*_{task}*_acq-mb8_run-*_desc-confounds_timeseries.tsv'), recursive=True))
