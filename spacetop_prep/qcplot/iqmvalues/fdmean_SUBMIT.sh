...
OUTPUTDIR="/dartfs-hpc/rc/lab/C/CANlab/labdata/data/spacetop_data/derivatives/fmriprep_qc/iqm"

python ${MAINDIR}\spacetop_prep/qcplot/iqmvalues/fd_mean_spacetop.py \
--slurm-id ${ID} \
